...
class GenerateProjectTestFile
{
    public static function getContent(
        ...
        if (! $classData->isClass) {
            throw new InvalidClassException($classData->className);
        }
        $reflectionTestFile = $classData->reflection;
        $fileName = $classData->fileName;

        $nameSpace = $reflectionTestFile->getNamespaceName();
        $file = new Nette\PhpGenerator\PhpFile;
        $file->addComment('## Test for all modells');
        $file->addComment("\n------\n");
        ...
        $class = $nameSpace->addClass($reflectionTestFile->getShortName());
